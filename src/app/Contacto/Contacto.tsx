    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <a
                  ...
                  className="mt-5 block font-display text-[clamp(2rem,5vw,2.875rem)] leading-[1.1] text-arena-clara transition-colors duration-[240ms] hover:text-white"
                >
                  658 89 06 07
                </a>
          ...
          <Reveal delay={620} className="mt-19 flex justify-center">
            <a
              href="tel:+34658890607"
